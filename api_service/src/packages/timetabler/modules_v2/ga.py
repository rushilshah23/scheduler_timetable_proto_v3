...
working_day_id = output["working_days"][0].id


data_pool = SlotData(
    slots=slots_generator(working_day_id=working_day_id),
    allotables=slot_allotables_generator(working_day_id=working_day_id)
)

CHROMOSOME_LENGTH = len(data_pool.slots)
...
#         IncompleteSlots(5,data_pool=data_pool,type='HARD', generic=generics),
#         NoSameSlotIdRepetition(1/2,data_pool=data_pool,type='HARD',generic=generics),
#         FixedAllotablesAtFixedSlot(2, data_pool=data_pool, type='HARD',generic=generics),
#         AllAllotablesMapped(3, data_pool=data_pool, type='HARD', generic=generics)
#     ]
# )
