...
from src.packages.timetabler.modules.constraints import NoSameSlotIdRepetition,FixedAllotablesAtFixedSlot,IncompleteSlots,DuplicateAllotables, MissingAllotables, ContinuousSlot
